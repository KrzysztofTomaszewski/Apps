...
//---------------------------------------------------------------------------
void __fastcall TForm1::z1MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TForm1::z2MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TForm1::z3MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TForm1::z4MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
...
//---------------------------------------------------------------------------
void __fastcall TForm1::z5MouseMove(TObject *Sender, TShiftState Shift,
      int X, int Y)
{
